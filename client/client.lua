...
RegisterNUICallback('takePhoto', function(data, cb)
	...
	while takePhoto do
    	...
    	elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
			...
			DestroyMobilePhone()
			CellCamActivate(false, false)
			exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/862160947207208960/7vkHYEoXg41F6HJhVXByvmNy_d9Mgvt2XFZnv1iTfZ6vGbstpiHgHmfM_zckku149F61", data.field, function(data)
